...
<template>
  <header class="flex h-(--header-height) shrink-0 items-center gap-2 border-be transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
