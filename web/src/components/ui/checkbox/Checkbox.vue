  ...
  >
    ...
    >
      <slot v-bind="slotProps">
        <Check class="block-3.5 inline-3.5" />
      </slot>
    </CheckboxIndicator>
  </CheckboxRoot>
</template>
