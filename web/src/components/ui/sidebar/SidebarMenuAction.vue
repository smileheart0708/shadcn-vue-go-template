...
const props = withDefaults(defineProps<PrimitiveProps & { showOnHover?: boolean; class?: HTMLAttributes['class'] }>(), { as: 'button' })
</script>
  ...
  <Primitive
    ...
    :class="
      cn(
        ...
        'peer-data-[size=lg]/menu-button:inset-bs-2.5',
