...
<template>
  <button
    ...
    :class="
      cn(
        'absolute inset-y-0 z-20 hidden -translate-x-1/2 transition-all ease-linear inline-4 group-data-[side=left]:-inset-e-4 group-data-[side=right]:inset-s-0 after:absolute after:inset-y-0 after:inset-s-1/2 after:inline-[2px] hover:after:bg-sidebar-border sm:flex',
